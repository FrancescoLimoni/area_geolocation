  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-full font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-[1.6px] border-primary bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
      ...
      size: {
        default: "rounded-full p-4 text-base",
        sm: "rounded-full p-2 text-xs",
        md: "rounded-full p-6 text-sm",
        lg: "rounded-full p-8 text-lg",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
